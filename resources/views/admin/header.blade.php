      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('all_product') }}" aria-expanded="false">
                <i class="ti ti-atom"></i>
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('add_show_category') }}" aria-expanded="false">
                <i class="ti ti-atom"></i>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  ...
                  href="{{ route('category.products', $cat->slug) }}" aria-expanded="false">
                  <div class="d-flex align-items-center gap-3">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('add_product') }}" aria-expanded="false">
                <i class="ti ti-atom"></i>
